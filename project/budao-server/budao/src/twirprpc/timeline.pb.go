...
func (*GetTimeLineRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (*GetTimeLineResponse) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
func (*GetSubscribedTimeLineRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{2} }
...
func (*GetSubscribedTimeLineResponse) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{3} }
...
func init() { proto.RegisterFile("timeline.proto", fileDescriptor9) }
