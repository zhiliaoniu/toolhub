...
func (*CommentVideoRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*CommentVideoResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*ReplyCommentRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (*ReplyCommentResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func (*GetVideoCommentListRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{4} }
...
func (*GetVideoCommentListResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{5} }
...
func (*GetCommentReplyListRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{6} }
...
func (*GetCommentReplyListResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{7} }
...
func init() { proto.RegisterFile("comment.proto", fileDescriptor1) }
