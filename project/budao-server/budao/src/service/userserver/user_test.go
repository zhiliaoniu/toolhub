...
func Test_Login(t *testing.T) {
	...
	req := &pb.LoginRequest{
		...
		//LoginType: 1,
		Openid: "ogTZl0QbRDWt8wWQwMfYHCp0cPbI",
		Token:  "10_zTOBmqyZmiK9MW8WxlzvUIJ5zqdoqCrGexKHd8axsHZfq6-X7JS1c2Tjv1nXgAlzpEaor2iC5hCXpp9ZRsw5AUtV7XmpJczSZwguu3wg2TA",
	}
