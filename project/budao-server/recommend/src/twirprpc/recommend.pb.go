...
func (*RecommendVideoItem) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*GetRecommendVideoRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*GetRecommendVideoResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (*ReloadIndexRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func (*ReloadIndexResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{4} }
...
func init() { proto.RegisterFile("recommend.proto", fileDescriptor1) }
