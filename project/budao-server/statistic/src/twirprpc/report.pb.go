...
func (*VideoBase) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*VideoClick) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*VideoProgress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (*VideoExposure) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func (*BannerClick) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{4} }
...
func (*ReportStatisDataRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{5} }
...
func (*ReportStatisDataResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{6} }
...
func (*ReportBatchDataRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{7} }
...
func (*ReportBatchDataResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{8} }
...
func init() { proto.RegisterFile("report.proto", fileDescriptor1) }
